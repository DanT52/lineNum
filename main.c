...
int main(int argc, char const *argv[]){
    ...
    // Define test cases
    char* words[] = {"fi sh", "youth", "zoo", "potato"};
    char* dicts[] = {"webster_16", "tiny_9", "tiny_9","webster_16"};
    int nums[] = {16, 9, 9, 16};  // Assuming a width of 16 for the last dictionary, adjust as necessary
